...
* Hard cap of 50 PRs (globally configurable) per merge train, for internal implementation reasons (we store some state in GitHub comments, which limits that state's size).
